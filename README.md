...
It is a pity that it does not work on Zigbee, so for the moment I monitor this device ~~via the Vegtug app~~ with an ESP32 using [ESPHome](https://esphome.io/components/sensor/xiaomi_ble.html?highlight=flower).
